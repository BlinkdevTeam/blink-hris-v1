...
// ── PROFILE PAGE ──────────────────────────────────────────────────────────────
function ProfilePage({ emp, onBack, onEdit, onUpdateEmp, empComp, onUpdateComp, basicPaySets, contributionSets, benefitsSets }) {
  ...
  return (
    <div className="flex-1 overflow-y-auto" style={{ backgroundColor: "#000" }}>
      ...
      <div className="px-8 py-6">
        ...
        {tab === "Compensation"  && <EmployeeCompensationTab emp={emp} onUpdateEmp={onUpdateEmp} empComp={empComp} onUpdateComp={onUpdateComp} basicPaySets={basicPaySets} contributionSets={contributionSets} benefitsSets={benefitsSets} />}
...
function EmployeeCompensationTab({ emp, onUpdateEmp, empComp, onUpdateComp, basicPaySets, contributionSets, benefitsSets }) {
...
// ── ROOT ──────────────────────────────────────────────────────────────────────
export default function PeopleWithSalaryEdit() {
