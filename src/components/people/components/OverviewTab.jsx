export default function OverviewTab({ emp }) {
  if (!emp) return <p className="text-white p-8">Loading employee…</p>;
      ...
      <div className="col-span-2 space-y-5">
        <div className="grid grid-cols-2 gap-4">
          {[
            ...
            { label: "Employment", value: emp.empType, icon: "💼" },
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-200 text-sm mt-0.5" style={{ fontFamily: "system-ui,sans-serif" }}>
                  {value || "-"}
                </p>
              </div>
            </div>
        ...
        <div className="rounded-lg p-5" style={{ backgroundColor: "#0d0d0d", border: "1px solid #1e1e1e" }}>
          ...
          {[
            ...
            <div key={label} className="flex justify-between py-2" style={{ borderBottom: "1px solid #1a1a1a" }}>
              ...
              <span className="text-gray-200 text-sm" style={{ fontFamily: "system-ui,sans-serif" }}>{value || "-"}</span>
            </div>
          ))}
        </div>
          ...
          {[
            ...
            <div key={label} className="mb-3">
              <div className="flex justify-between mb-1">
                <span className="text-gray-400 text-xs" style={{ fontFamily: "system-ui,sans-serif" }}>{label}</span>
                <span className="text-gray-500 text-xs" style={{ fontFamily: "monospace" }}>{used}/{total}d</span>
              </div>
